    ...
    try {
        ...
        if (body.type === 'preapproval' || body.type === 'subscription_preapproval') {
            ...
            if (subscription.status === 'authorized') {
                ...
                // Parse external_reference logic updated for new format
                ...
                // Si detectamos un cambio de plan en la referencia, lo actualizamos también
                if (newPlan) {
                ...
                // Actualizamos usando el tenantId extraído
