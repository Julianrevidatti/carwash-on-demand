...
export const Inventory: React.FC = () => {
    ...
    const resetProductForm = () => {
        setPName(''); setPBarcode(''); setPCost(''); setPMargin('30'); setPSupplier(''); setPManualPrice(false); setPPrice('');
        setPSize(''); setPColor(''); setPSeason(''); setPBrand(''); setEditingId(null);
    };
    ...
    const handleSaveProduct = () => {
        ...
        const product: Product = {
            ...
            size: pSize, color: pColor, season: pSeason, brand: pBrand
        };
    ...
    const handleEditProduct = (p: Product) => {
        ...
        setPSize(p.size || ''); setPColor(p.color || ''); setPSeason(p.season || ''); setPBrand(p.brand || '');
                    ...
                    <table style={{ width: '100%', fontSize: '13px', borderCollapse: 'collapse' }}>
                        <thead>
                            <tr style={{ background: '#f8fafc' }}>
                                ...
                                <th style={{ padding: '12px 16px', textAlign: 'left', color: '#000000', fontSize: '11px', fontWeight: '500' }}>Marca/Temp</th>
                                <th style={{ padding: '12px 16px', textAlign: 'left', color: '#000000', fontSize: '11px', fontWeight: '500' }}>Talle/Color</th>
                                ...
                                return (
                                    <tr key={p.id} style={{ borderBottom: '1px solid #ffffff' }}>
                                        <td style={{ padding: '10px 16px' }}>
                                            ...
                                            <p style={{ color: '#000000', fontSize: '11px', fontFamily: 'monospace' }}>{p.barcode || '-'}</p>
                                        </td>
                                        <td style={{ padding: '10px 16px', color: '#000000' }}>
                                            <p style={{ fontSize: '12px' }}>{p.brand || '-'}</p>
                                            <p style={{ fontSize: '11px', opacity: 0.7 }}>{p.season || '-'}</p>
                                        </td>
                                        <td style={{ padding: '10px 16px', color: '#000000' }}>
                                            <p style={{ fontSize: '12px', fontWeight: '600' }}>{p.size || '-'}</p>
                                            <p style={{ fontSize: '11px', opacity: 0.7 }}>{p.color || '-'}</p>
                                        </td>
                    ...
                    <div style={modalBox}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                                <div><label style={{ display: 'block', fontSize: '11px', fontWeight: '500', color: '#000000', marginBottom: '4px' }}>Talle</label>
                                    <input value={pSize} onChange={e => setPSize(e.target.value)} style={inputStyle} placeholder="ej. XL, 42" /></div>
                                <div><label style={{ display: 'block', fontSize: '11px', fontWeight: '500', color: '#000000', marginBottom: '4px' }}>Color</label>
                                    <input value={pColor} onChange={e => setPColor(e.target.value)} style={inputStyle} placeholder="ej. Rojo, Azul" /></div>
                            </div>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                                <div><label style={{ display: 'block', fontSize: '11px', fontWeight: '500', color: '#000000', marginBottom: '4px' }}>Temporada</label>
                                    <input value={pSeason} onChange={e => setPSeason(e.target.value)} style={inputStyle} placeholder="ej. Invierno 2026" /></div>
                                <div><label style={{ display: 'block', fontSize: '11px', fontWeight: '500', color: '#000000', marginBottom: '4px' }}>Marca</label>
                                    <input value={pBrand} onChange={e => setPBrand(e.target.value)} style={inputStyle} placeholder="ej. Nike, Zara" /></div>
                            </div>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
