...
export const POS: React.FC = () => {
    ...
    const getLayoutProportions = () => {
        switch (settings.posLayout) {
            ...
            case 'checkout-focused': return { grid: 0.8, side: 1.2 };
            case 'compact': return { grid: 1.5, side: 0.5 };
            case 'classic': default: return { grid: 2, side: 1 };
        }
    };
    ...
    const SidebarActions = () => (
        <div style={{
            ...
            gap: '12px',
            padding: '16px',
            borderTop: settings.posSidebarActions === 'bottom' ? '1px solid #ffffff' : 'none',
    ...
    return (
        <div style={{
            ...
            gap: '0',
            background: '#f8fafc',
            flexDirection: settings.posReverseLayout ? 'row-reverse' : 'row'
        }}>
            {/* Left: Product Grid */}
            <div style={{
                ...
                <div style={{
                    ...
                    padding: '16px',
                    display: 'grid',
                    gridTemplateColumns: proportions.grid < 1 
                    ...
                    {filteredProducts.map(product => (
                        ...
                        >
                            <p style={{
                                ...
                                {product.name}
                                {product.size && <span style={{ opacity: 0.7 }}> ({product.size})</span>}
                            </p>
                            <p style={{
                                fontSize: '18px',
                                fontWeight: '700',
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        ...
                        <span style={{ fontWeight: '600', fontSize: proportions.side < 0.8 ? '13px' : '15px' }}>
                            {proportions.side < 0.8 ? cart.length : `Carrito (${cart.length})`}
                        </span>
                    </div>
                    {cart.length > 0 && proportions.side > 0.6 && (
                        <button
                            onClick={() => setCart([])}
                            style={{
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                        <div style={{
                                            ...
                                            <button
                                                ...
                                                style={{ width: '24px', height: '24px', borderRadius: '4px', border: 'none', background: '#f8fafc', cursor: 'pointer' }}
                                            >
                                                <Minus size={10} />
                                            </button>
